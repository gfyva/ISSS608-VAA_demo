...
# **14. Modelling, Visualising and Analysing Network Data with R**
...
Four network data modelling and visualisation packages will be installed and launched. They are igraph, tidygraph, ggraph and visNetwork. Besides these four packages, tidyverse and lubridate, an R package specially designed to handle and wrangling time data will be installed and launched too.
...
![](images/Screenshot%202026-06-02%20205215.png){width="544"}

### **14.3.2 The nodes data**

*GAStech_email_nodes.csv* which consist of the names, department and title of the 55 employees.

![](images/Screenshot%202026-06-02%20205405.png){width="498"}
...
![](images/Screenshot%202026-06-02%20233655.png){width="525"}
...
![](images/Screenshot%202026-06-03%20232953.png){width="578"}

![](images/Screenshot%202026-06-03%20233350.png){width="579"}

![](images/Screenshot%202026-06-03%20233510.png){width="577"}
...
- *geom_node_point* is equivalent in functionality to *geo_point* of **ggplot2**. It allows for simple plotting of nodes in different shapes, colours and sizes. In the code chunks above, colour and size are used.
...
**1) Exploring more colours to the plot**
...
- Shapes 21–25 are “filled shapes” - you will be allowed to change the colour and fill and colour the node points

**2) Exploring ggraph’s layouts**
