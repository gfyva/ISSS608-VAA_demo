...
- Learn to create ridgeline plots
- Learn to create raincloud plots
- Apply these techniques using ggplot2 and its extensions
...
![](images/Exam_data3.csv.png){width="421"}
...
![](images/clipboard-307161376.png){width="530"}
