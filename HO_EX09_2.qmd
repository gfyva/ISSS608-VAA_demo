...
# **18 Visualising Geospatial Point Data**
...
## **18.4 Geospatial Data Wrangling**
...
![](images/Screenshot%202026-06-14%20000951.png){width="711"}

### **18.4.2 Data Import and Preparation**
...
### **18.4.3 Creating a sf data frame from an aspatial data frame**
...
![](images/Screenshot%202026-06-14%20001132.png)
...
## **18.5 Drawing Proportional Symbol Map**
...
### **18.5.1 It all started with an interactive point symbol map**

The code chunk below are used to create an interactive point symbol map.
...
### **18.5.2 Lets make it proportional**
...
### **18.5.3 Lets give it a different colour**
