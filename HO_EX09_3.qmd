...
### **19.2.1 Installing and loading packages**
...
## **19.3 Basic Choropleth Mapping**

### **19.3.1 Visualising distribution of non-functional water point**
...
## **19.4 Choropleth Map for Rates**

In much of our readings we have now seen the importance to map rates rather than counts of things, and that is for the simple reason that water points are not equally distributed in space. That means that if we do not account for how many water points are somewhere, we end up mapping total water point size rather than our topic of interest.

### **19.4.1 Deriving Proportion of Functional Water Points and Non-Functional Water Points**
...
#### 19.5.1.2 Why writing functions?
...
#### 19.5.1.3 Creating the get.var function
...
#### 19.5.1.4 A percentile mapping function
...
#### 19.5.1.5 Test drive the percentile mapping function
...
#### 19.5.2.1 Creating the boxbreaks function
...
#### 19.5.2.2 Creating the get.var function
...
#### 19.5.2.3 Test drive the newly created function
