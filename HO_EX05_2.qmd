...
## **10.1 Overview & Learning Outcome**
...
- Create correlation matrix visualisations using [*pairs()*](https://www.rdocumentation.org/packages/graphics/versions/3.6.0/topics/pairs) of R Graphics

- Plot corrgrams using the **corrplot** package

- Build interactive correlation matrix visualisations using plotly R
...
Notice that besides quality and type, the rest of the variables are numerical and continuous data type.
...
**Exploring other *method* arguments**
...
**Exploring other layout design arguments**

::: panel-tabset
## tl.cex & tl.srt

tl.cex - controls the size of the labels

tl.srt - rotates the labels to reduce overlapping
...
cl.pos - changes the location of the colour legend

cl.cex - adjusts the legend text size
