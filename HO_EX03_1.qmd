---
title: "Hands-on Exercise 3 Part 1 250426"
author: "Goh Fang Yu"
date: "25 Apr 2026"
...
![](images/Exam_data2.csv.png){width="447"}

## **3.4 Interactive Data Visualisation - ggiraph methods**

ggiraph is an htmlwidget and a ggplot2 extension.

It allows ggplot graphics to be interactive.
...
Next, this newly created field is used as tooltip field as shown in the code of line 7.
...
Code chunk below shows an advanced way to customise tooltip.
...
Coordinated multiple views methods has been implemented in the data visualisation above.
...
#### **1) Displaying more information on tooltip**

In this example, Name, Class, Gender and Race is being displayed.
...
#### **2) Changing the background colour and font of tooltip**

Background colour of the tooltip is blue, font is white and bold and font family is sans-serif

```{r}
tooltip_css <- "background-color:blue; #<<
font-style:bold; color:white; font-family:sans-serif" #<<
...
#### **3) Displaying other kind of Statistics on tooltip**

This example shows the minimum and maximum Maths score for each class.
...
#### **4) Changing the position of how we present the data**
