...
![](images/Screenshot%202026-06-06%20145552-01.png){width="603"}
...
![](images/Screenshot%202026-06-10%20221620.png){width="624"}

### **16.3.7 Plotting Multiple Calendar Heatmaps**
...
### **16.3.8 Plotting Multiple Calendar Heatmaps**
...
![](images/clipboard-3787531190.png){width="692"}
...
### **16.4.3 Step 3: Extracting the target country**
...
### **16.4.4 Step 4: Computing year average arrivals by month**
...
### **16.4.5 Step 5: Plotting the cycle plot**
...
Exploring another presentation for the cycle plot
...
```{r}
source("https://raw.githubusercontent.com/ibecav/CGPfunctions/master/R/newggslopegraph.R") 
...
Exploring another presentation for the slopegraph
...
rice %>%
  ...
  newggslopegraph(Year, Yield, Country,
                  ...
                  Caption = "Prepared by: Goh Fang Yu",
...
#### **Cheatsheet for lubridate** [(source)](https://lubridate.tidyverse.org/#cheatsheet)

<iframe src="lubridate.pdf" width="100%" height="600px">
